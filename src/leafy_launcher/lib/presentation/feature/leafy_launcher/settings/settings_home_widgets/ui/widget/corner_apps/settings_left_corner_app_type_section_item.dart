...
class SettingsLeftCornerAppTypeSectionItem extends StatelessWidget {
  const SettingsLeftCornerAppTypeSectionItem({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = context.settingsHomeWidgetsController;
    final selectedApp = controller.state.watch.leftCornerApp;
    ...
    return LeafySectionTextItem(
      ...
      onTap: () async {
        ...
        if (selected != null) {
          controller.raiseEvent.setLeftCornerApp(selected);
        }
      },
    );
  }
